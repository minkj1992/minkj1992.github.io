...
github 레포 관리를 하고 있어서, readme파일 대신 임의의 네이밍을 가진 markdown으로 대체하여 올립니다.
<!--more-->
...
## 생각의 흐름에 따른 글
파인만 교수는 인공지능이 사람을 따라잡을 수 없는 이유를 근거로 패턴인식을 말하였었다. 이는 오래전의 영상이고 현재의 인공지능은 튜링 테스트도 의미없을 만큼의 자연스러운 nlp와 패턴인식에서의 강점들을 보이고 있다. 

앤드류융이 말하는 30년 50년은 무슨 근거로 그렇게 말하는지 모르겠다. 이미 구글의 AI리더 또한 무서운 속도라고 말하기도 하였고 샘알트만도 어느정도 인정을 하는 부분임에도 융 교수님은 그렇게 말하지 않는 것을 보면서 아쉬움을 느꼈다. 물론 포럼이 AI 투자나 비즈니스 자리니 그렇게 말할 수 있지만 추상적인 기간으로 대중들을 안심시키는 것 같아 별로 좋게 보이진 않았다.

사실 가장 좋았던 기사는 첫번째 기사로, 논리적으로 jarvis가 가지고 있어야 할 기능들을 리스트업 하고 start small로 하나하나 접근해 가는 과정이 재밌었다.

## 앞으로
> 의식에 흐름에 맡긴 회고.. (부정적 내용 주의)

다가올 AI시대, 그게 융 교수님 말씀처럼 최대 30년이 걸린다고 하더라도 만약 30년 뒤에 그럼 미래는 어떻게 될까? 미묘하게 인간만 파악하던 패턴 인식들도, AI가 더 빠른 컴퓨팅으로 빠르게 처리할 것이고, 운동도 로봇이 더 잘할 것이다. 

계산능력은 이미 졌고, rule based 업무 또는 게임들은 이미 예전에 졌다. 

그럼 남아있는 걸 흔히 창의성에 대해서 말하는데, 창의성 또한 과거의 데이터로 부터 나오는 것. 그런 면에서 AI는 창의적일 수 있다. 또한 창의적인지 아닌지는 대중들의 수준에 의해서 만들어지는 것인데. 창의적이지 못한 대중들이 다수 존재한다면 창의적이지 않아도 비슷하게 output들을 data augmentation하듯이 조금씩 바꿔가면서 copycat을 하면 창의적이라고 박수 갈채를 받을지도

(로봇 = AI) 로봇이 농사를 짓고, 로봇이 교육해주고, 로봇이 전쟁하고, 로봇이 운전하고, 등등.. 지구라는 별에서 인간이 할 행동들이 점점 줄어드는 느낌이 든다. 어차피 "로봇과 AI가 나보다 잘할건데 내가 해서 뭐하냐?" 같은 생각들.. 아마 미래에는 각 사람들은 자신이 왜 살아야 하는지를 깊게 고민해보고 인간 내면의 것들이 더 주목 받을 것 같다. (무의식, 신앙, 양심, 명상 등) 이는 0/1로 구성된 논리적 사고에 기반을 둔 로봇은 할 수 없는 즉 유물론을 따르지 않는 내용들이기 떄문에.
